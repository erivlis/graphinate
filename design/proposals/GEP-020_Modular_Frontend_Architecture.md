...
The Graphinate Viewer is currently implemented as a single monolithic `index.html` file containing HTML, CSS, and JavaScript. This proposal advocates for refactoring the frontend code into modular ES6 JavaScript files and adopting a lightweight window management library to improve maintainability and readability.

## Motivation

**Issues:**
1.  **Readability:** A 500+ line HTML file mixing three languages is hard to read.
2.  **Maintainability:** Logic is tightly coupled. The custom "Floating Panel" implementation (drag/resize/stacking) is verbose and reinventing the wheel.
