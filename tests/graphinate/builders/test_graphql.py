...
from graphinate import converters
...
# The raw identifier for the edge is ((0,), (1,)).
# The new, correct edgeId is generated by singly-encoding this tuple.
new_edge_id = converters.encode(((0,), (1,)))
...
graphql_operations_cases = [
    ...
    ((
        f'query Graph {{\n'
        f'nodes(nodeId: "KDAsKQ==") {{type label}}\n'
        f'edges(edgeId: "{new_edge_id}") {{type label}}\n'
        f'}}'
     ),
     # noqa: E501
     {
