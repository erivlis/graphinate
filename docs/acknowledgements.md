...
<a href="https://astral.sh/uv"><img style="height: 50px; padding: 15px; background: linear-gradient(-45deg, #FFFFFF, #CCCCCC);" src="https://docs.astral.sh/uv/assets/logo-letter.svg" alt="uv logo."></a>
