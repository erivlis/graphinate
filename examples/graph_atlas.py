...
def get_graph():
    ...
    ladder_ring = nx.Graph.copy(ladder)
    ladder_ring.add_edge(ladder_size, ladder_size * 2 - 1)
    ladder_ring.add_edge(0, ladder_size - 1)

    ladder_mobius = nx.Graph.copy(ladder)
    ...
    adjacencies = {
        ...
        'Small Rhombicosidodecahedral Graph': {1: [2, 3, 4, 5],
                                               2: [1, 54, 55, 59],
                                               3: [1, 53, 56, 60],
                                               4: [1, 5, 58, 60],
                                               5: [1, 4, 57, 59],
        ...
        # 'Icosahedral Line Graph': {
        #     1: [2, 3, 4, 5, 6, 7, 8, 9],
        #     2: [1, 4, 6, 8, 15, 19, 23, 27],
        #     3: [1, 5, 7, 9, 16, 20, 24, 28],
        #     4: [1, 2, 6, 8, 17, 22, 23, 29],
        #     5: [1, 3, 7, 9, 18, 21, 24, 30],
        #     6: [1, 2, 4, 7, 8, 25, 27, 28],
        #     7: [1, 3, 5, 6, 9, 25, 27, 28],
        #     8: [1, 2, 4, 6, 9, 26, 29, 30],
        #     9: [1, 3, 5, 7, 8, 26, 29, 30],
        #     10: [11, 12, 14, 15, 16, 20, 21, 25],
        #     11: [10, 13, 14, 15, 16, 19, 22, 25],
        #     12: [10, 13, 14, 17, 18, 20, 21, 26],
        #     13: [11, 12, 14, 17, 18, 19, 22, 26],
        #     14: [10, 11, 12, 13, 19, 20, 21, 22],
        #     15: [2, 10, 11, 16, 19, 23, 25, 27],
        #     16: [3, 10, 11, 15, 20, 24, 25, 28],
        #     17: [4, 12, 13, 18, 22, 23, 26, 29],
        #     18: [5, 12, 13, 17, 21, 24, 26, 30],
        #     19: [2, 11, 13, 14, 15, 22, 23, 27],
        #     20: [3, 10, 12, 14, 16, 21, 24, 28],
        #     21: [5, 10, 12, 14, 18, 20, 24, 30],
        #     22: [4, 11, 13, 14, 17, 19, 23, 29],
        #     23: [2, 4, 15, 17, 19, 22, 27, 29],
        #     24: [3, 5, 16, 18, 20, 21, 28, 30],
        #     25: [6, 7, 10, 11, 15, 16, 27, 28],
        #     26: [8, 9, 12, 13, 17, 18, 29, 30],
        #     27: [2, 6, 7, 15, 19, 23, 25, 28],
        #     28: [3, 6, 7, 16, 20, 24, 25, 27],
        #     29: [4, 8, 9, 17, 22, 23, 26, 30],
        #     30: [5, 8, 9, 18, 21, 24, 26, 29]
        # },
